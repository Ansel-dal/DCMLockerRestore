...
sudo git clone https://github.com/DCMSolutions/DCMLockerv3 /home/pi/DCMLockerv3
...
[Service]
 WorkingDirectory=/home/pi/DCMLockerv3
 ExecStart=/opt/dotnet/dotnet /home/pi/DCMLockerv3/DCMLocker.Server.dll
 Restart=always   
